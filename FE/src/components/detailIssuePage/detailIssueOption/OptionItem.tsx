...
import { issueFilterTypeState, selectedTabType, issueFilterSelectState } from 'store/issueInfoStore';
...
export default function OptionItem({ optionName, optionKey, optionRef, selectedOption }: Props) {
  ...
  const { assignee: selectedAssignee, label: selectedLabel, milestone: selectedMilestone } = selectedOption;
