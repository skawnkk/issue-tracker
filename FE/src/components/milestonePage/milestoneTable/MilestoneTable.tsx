...
import MilestoneItem from 'components/milestonePage/milestoneTable/MilestoneItem';
...
function MilestoneTable() {
  ...
  const { closedMilestonesCount, openedMilestonesCount, milestones } = useRecoilValue(getMilestones);
