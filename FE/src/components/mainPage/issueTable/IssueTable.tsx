...
import IssueListHeader from 'components/mainPage/issueTable/issueTableHeader/IssueTableHeader';
import IssueItem from 'components/mainPage/issueTable/IssueItem';
